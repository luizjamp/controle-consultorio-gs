...
# Converted on Wed, 17 Jun 2020 10:51:21 -0400
...
CREATE TABLE consulta (
    ...
    id_medico int(11),
    id_paciente int(11),
    atestado_nome varchar(100),
    atestado_rg varchar(50),
    atestado_ int(11),
    atestado_hora_inicio timestamp,
    atestado_hora_fim timestamp,
    atestado_dias_repouso varchar(100),
    atestado_cid varchar(50),
    id_saladeespera int(11),
    tempo_espera int(11)
) ;
...
CREATE TABLE system_group_program (
    id int(11) NOT NULL,
    system_group_id int(11),
    system_program_id int(11)
) ;

CREATE TABLE system_message (
    id int(11) NOT NULL,
    system_user_id int(11),
    system_user_to_id int(11),
    subject text,
    message text,
    dt_message text,
    checked varchar(1)
...
ALTER TABLE saladeespera
    ADD CONSTRAINT saladeespera_pkey PRIMARY KEY (id);
